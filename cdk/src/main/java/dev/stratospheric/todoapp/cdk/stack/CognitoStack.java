...
public class CognitoStack extends Stack {
  ...
  public CognitoStack (
    ...
    super(scope, id, StackProps.builder().stackName(applicationEnvironment.prefix("Cognito"))
    ...
    this.userPool = UserPool.Builder.create(this, "userPool")
      ...
      .standardAttributes(
        StandardAttributes.builder().email(StandardAttribute.builder().required(true).mutable(false).build())
          .build()
      )
    ...
    this.userPoolClient = UserPoolClient.Builder.create(this, "userPoolClient")
      ...
      .oAuth(OAuthSettings.builder()
        ...
        .scopes(Arrays.asList(OAuthScope.EMAIL, OAuthScope.OPENID, OAuthScope.PROFILE))
          .build())
      .supportedIdentityProviders(Collections.singletonList(
...
//
  ...
  private void createOutputParameters(Environment awsEnvironment) {
    ...
    // https://github.com/stratospheric-dev/stratospheric/pull/184/commits
    /*
