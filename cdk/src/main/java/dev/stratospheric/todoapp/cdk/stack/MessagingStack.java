...
public class MessagingStack extends Stack {
  ...
  public MessagingStack(
    ...
    super(scope, id, StackProps.builder().stackName(applicationEnvironment.prefix("Messaging"))
    ...
    this.todoSharingQueue = Queue.Builder.create(this,"todoSharingQueue" )
      ...
      .visibilityTimeout(Duration.seconds(30)) // avoid parallel consumption
      .retentionPeriod(Duration.days(14))
      .deadLetterQueue(
  ...
  private static String createParameterName(ApplicationEnvironment applicationEnvironment, String parameterTodoSharingQueueName) {
    return applicationEnvironment.getEnvironmentName() + "-" + applicationEnvironment.getApplicationName()
      + "-Messaging-" + parameterTodoSharingQueueName;
  }
